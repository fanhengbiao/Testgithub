package com.android.slideandDrg;
...
public class DragListView<T> extends ListView implements View.OnDragListener {
    ...
    private void setItemVisible(ItemMainLayout itemMainLayout) {
    	itemMainLayout.getItemCustomLayout().getBackGroundImage().setBackgroundResource(R.drawable.drag_while);
    	itemMainLayout.getItemLeftBackGroundLayout().getBackGroundImage().setBackgroundResource(R.drawable.drag_while);
    	itemMainLayout.getItemRightBackGroundLayout().getBackGroundImage().setBackgroundResource(R.drawable.drag_while);
	...
	protected void setDragPosition(int position) {
        ...
        if (mOnDragListener != null) {
            ...
            view.getItemCustomLayout().getBackGroundImage().setBackgroundResource(R.drawable.drag_grap);
            view.getItemLeftBackGroundLayout().getBackGroundImage().setBackgroundResource(R.drawable.drag_grap);
            view.getItemRightBackGroundLayout().getBackGroundImage().setBackgroundResource(R.drawable.drag_grap);
